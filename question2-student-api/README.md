...
6. The application will be accessible at `http://localhost:8087`.
...
Request: `GET http://localhost:8087/api/students/major/Computer Science`

2. Filter by GPA
Method: GET

URL: http://localhost:8087/api/students/filter?gpa=3.5
result
...
URL: http://localhost:8087/api/students/major/Computer Science
...
URL: http://localhost:8087/api/students/1
